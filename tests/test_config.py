...
class TestConfig(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self._saved = {k: os.environ.get(k) for k in ("COOLTH_CONFIG", "XDG_CONFIG_HOME")}
    ...
    def test_basic_keys(self) -> None:
        self._write("account = me@example.com\npassword = secret\nhost = 12345\ncloud = true\n")
    ...
    def test_no_file(self) -> None:
        ...
        os.environ["COOLTH_CONFIG"] = str(Path(self._tmp.name) / "does-not-exist.env")
        config.load_config_file()
