...
from coolth.cloud_lan import (CloudLAN, _extract_aa, _timestamp,
                              build_5a5a_packet)
...
class TestCrypto(unittest.TestCase):
    ...
    def test_derive_key(self) -> None:
        ...
        token = AES.new(k, AES.MODE_ECB).encrypt(
            Padding.pad(known_key, 16)).hex()
    ...
    def test_iv_recovery_math(self) -> None:
        ...
        our_ct = AES.new(key, AES.MODE_CBC, iv=zero).encrypt(
            Padding.pad(text, 16))
